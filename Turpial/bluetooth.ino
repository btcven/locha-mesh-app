...
#define CHARACTERISTIC_UUID_RX  "6E400002-B5A3-F393-E0A9-E50E24DCCA9E" // UUID RX
#define CHARACTERISTIC_UUID_TX  "6E400003-B5A3-F393-E0A9-E50E24DCCA9E" // UUID TX
...
void bluetooth_task(void *params) {
  ...
  // device name is: mac_address + ".locha.io"
  std::string ble_mac_addr;
  //BLEAddress( ble_mac_addr);
  Serial.printf(ble_mac_addr.c_str());
  Serial.printf("\n");
  ...
  while (1) {
    if (deviceConnected) {
      ...
      if (!deviceConnected && oldDeviceConnected) {
        // give the bluetooth stack the chance to get ready
        delay(500);
        // restart advertising
