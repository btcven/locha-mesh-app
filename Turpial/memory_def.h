...
#define MEMORY_DEF_H
  ...
  static const int HELLO_RETRY_TIMEOUT=10000;     // tiempo maximo desde que se recibio el ultimo packet para enviar un HELLO nuevamente y verificar si hay nodos nuevos
